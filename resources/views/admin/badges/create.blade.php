...
<div class="px-4 py-2">
    <div class="flex items-center space-x-2">
        <h2 class="text-2xl font-bold mb-6 text-gray-800">バッジ（グループ）作成</h2>
    </div>
    ...
    <div class="bg-white p-6 rounded-xl shadow-sm border border-gray-100 max-w-2xl">
        <form action="{{ route('admin.badges.store') }}" method="POST" class="space-y-6">
            ...
            <div class="flex items-center justify-end space-x-4">
                <a href="{{ route('admin.badges.applications') }}" class="text-gray-500 hover:text-gray-700 font-medium">
                    キャンセル
                </a>
                <button type="submit" 
