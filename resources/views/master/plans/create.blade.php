                ...
                <form action="{{ route('master.plans.store') }}" method="POST" class="space-y-4">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div>
                            ...
                            <input type="text" name="display_name" placeholder="POCKET" value="{{ old('display_name') }}" class="mt-1 block w-full border-gray-300 dark:bg-gray-700 dark:text-white rounded-md">
                        </div>
                        <div>
                            <label class="block text-sm font-medium">プラン識別子 (slug)</label>
                            <input type="text" name="slug" placeholder="pocket" value="{{ old('slug') }}" class="mt-1 block w-full border-gray-300 dark:bg-gray-700 dark:text-white rounded-md">
